...
void initTIM3() {
	...
	TIM_TimeBaseStruct.TIM_Prescaler = (uint16_t) (((SystemCoreClock/2) / 10000) - 1);     // Adjusts timer frequency from 84 MHz to 100 KHz, *value must be less than 65535
	TIM_TimeBaseStruct.TIM_Period = (uint32_t) (10000 - 1);                               		// Timer period of 100 Hz (down from 100 KHz), *value must be less than 65535
